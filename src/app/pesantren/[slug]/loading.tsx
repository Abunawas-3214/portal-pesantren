  ...
  return (
    <main>
      <div className="container mx-auto max-w-screen-xl py-20 px-4 md:px-0 lg:py-40 space-y-24">
        <div className="animate-pulse grid grid-cols-1 lg:grid-cols-7 gap-10">
          <div className="col-span-1 lg:col-span-5 h-fit w-full border py-6 px-4 lg:px-9 space-y-10">
            ...
            <div className="w-full space-y-4">
              <div className="w-full h-[20rem] md:h-[30rem] rounded-lg bg-slate-200"></div>
              {/* Thumbnail Skeleton - Shown on Desktop */}
              <div className="hidden md:grid grid-cols-5 gap-4">
                <div className="w-full h-20 rounded-lg bg-slate-200"></div>
                <div className="w-full h-20 rounded-lg bg-slate-200"></div>
                <div className="w-full h-20 rounded-lg bg-slate-200"></div>
                <div className="w-full h-20 rounded-lg bg-slate-200"></div>
                <div className="w-full h-20 rounded-lg bg-slate-200"></div>
